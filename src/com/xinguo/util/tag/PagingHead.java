...
import com.xinguo.util.page.BasePagingController;
...
public class PagingHead extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			...
			pageContext.getOut().println(
					html.substring(0, html.indexOf(" </td>")));
	...
	public int doEndTag() throws JspException {
		...
		try {
			pageContext.getOut()
					.println(html.substring(html.indexOf(" </td>")));
		} catch (IOException ioe) {
			throw new JspException(ioe);
		}
	...
	protected String genUrl(PageModel pm, String contextPath) {
		...
		String fullUrl = contextPath + url
				...
				+ "&" + BasePagingController.TO_PAGE_NO_PARAM + "=1" + "&"
